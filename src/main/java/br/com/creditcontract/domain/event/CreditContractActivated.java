...
/** Fact emitted when asynchronous processing activates an accepted contract. */
public record CreditContractActivated(
		UUID eventId,
	...
	public static final String EVENT_TYPE = "CreditContractActivated";
	public static final int SCHEMA_VERSION = 1;

	public CreditContractActivated {
	...
	public static CreditContractActivated create(
			ContractId aggregateId,
			LocalDateTime occurredAt,
			EventContext context) {
		Objects.requireNonNull(context, "event context is required");
		return new CreditContractActivated(
				UUID.randomUUID(),
				aggregateId,
				occurredAt,
